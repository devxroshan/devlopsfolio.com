...
export const multerStorage = multer({ storage: multerMemoryStorage, limits: { files: 5, fileSize: 5 * 1024 * 1024 } });
...
app.use("/api/v1/profile", express.raw({ type: "*/*", limit: "5MB" }), profileRoutes);
